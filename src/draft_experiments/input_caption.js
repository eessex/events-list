...
class InputCaption extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const actions = <div style={styles.buttons}>
          <button
            id='ITALIC'
...
const linkIcon = () => {
  return (
    <svg>
      <path fill="#000000" d="M14.7,1c-1.3-1.3-3.7-1.3-5,0L7.1,3.6c-0.7,0.7-1,1.6-1,2.5c-0.9,0-1.8,0.3-2.5,1L1,9.7
